  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved debt as @debt" do
        ...
        post :create, {:debt => { "title" => "invalid value" }}, valid_session
        assigns(:debt).should be_a_new(Debt)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested debt" do
        ...
        Debt.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => debt.to_param, :debt => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the debt as @debt" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Debt.any_instance.stub(:save).and_return(false)
        put :update, {:id => debt.to_param, :debt => { "title" => "invalid value" }}, valid_session
        assigns(:debt).should eq(debt)
      end
